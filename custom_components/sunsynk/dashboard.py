                        ...
                        "cards": [
                            {
                                ...
                                "entities": {
                                    k: v for k, v in {
                                        # pv1_power_186 is required by the card whenever
                                        # show_solar is set — fall back to the combined
                                        # solar power sensor if no per-MPPT sensor exists.
                                        "pv1_power_186": pv1_power or solar_power,
                                        "pv2_power_187": pv2_power,
                                        "pv1_voltage_109": pv1_voltage,
                                        "pv2_voltage_111": pv2_voltage,
                                        "pv_total": solar_power,
                                        "day_pv_energy_108": pv_today,
                                        "battery_power_190": bat_power,
                                        "battery_soc_184": bat_soc,
                                        "battery_voltage_183": bat_voltage,
                                        "battery_current_191": bat_current,
                                        "battery_temp_182": bat_temp,
                                        "day_battery_charge_70": bat_chg_today,
                                        "day_battery_discharge_71": bat_dschg_today,
                                        "grid_power_169": grid_power,
                                        "day_grid_import_76": grid_imp_today,
                                        "day_grid_export_77": grid_exp_today,
                                        "day_load_energy_84": load_today,
                                        "inverter_power_175": inv_pac,
                                        "load_frequency_192": grid_freq,
                                        # Literal "none" tells the card to derive these
                                        # from inverter_power_175 / grid_power_169 instead
                                        # of a dedicated essential/non-essential sensor.
                                        "essential_power": "none",
                                        "nonessential_power": "none",
                                    }.items() if v is not None
                                },
                                "solar": {"mppts": 2 if pv2_power is not None else 1, "show_daily": True},
                                "battery": {"shutdown_soc": 10, "show_daily": True},
                                "grid": {"show_nonessential": False, "show_daily_buy": True, "show_daily_sell": True},
                                "load": {"show_daily": True},
                            },
                            {
