...
WRITABLE_SWITCHES: tuple[SunsynkSwitchEntityDescription, ...] = (
    ...
    SunsynkSwitchEntityDescription(
        key="setting_time2on",
        name="Grid Charge Slot 2",
        setting_key="time2on",
        entity_category=EntityCategory.CONFIG,
    ),
    SunsynkSwitchEntityDescription(
        key="setting_time3on",
        name="Grid Charge Slot 3",
        setting_key="time3on",
        entity_category=EntityCategory.CONFIG,
    ),
    SunsynkSwitchEntityDescription(
        key="setting_time4on",
        name="Grid Charge Slot 4",
        setting_key="time4on",
        entity_category=EntityCategory.CONFIG,
    ),
    SunsynkSwitchEntityDescription(
        key="setting_time5on",
        name="Grid Charge Slot 5",
        setting_key="time5on",
        entity_category=EntityCategory.CONFIG,
    ),
    SunsynkSwitchEntityDescription(
        key="setting_time6on",
        name="Grid Charge Slot 6",
        setting_key="time6on",
        entity_category=EntityCategory.CONFIG,
    ),
    SunsynkSwitchEntityDescription(
